...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Car[] cars = new Car[4];
        cars[0] = new Car(1,"Opel", "Cadet", 2010, "red", 500.0, 111);
        cars[1] = new Car(1,"Opel", "Cadet", 2010, "red", 500.0, 111);
        cars[2] = new Car(2,"Mercedes", "E300", 2015, "black", 2500.0, 222);
        cars[3] = new Car(3,"BMW", "X5", 2017, "white", 15500.0, 333);
                ...
                try {
                    switch (action){
                        ...
                        case 3:
                            ...
                            List<Car> carsOfPrice = car.carsOfNeededPrice(cars, yearOfProduction, price);
                            logger.info(carsOfPrice.toString());
                            break;
                        case 4:
                            int similarCars = car.similarCars(cars);
                            logger.info(
                                    "Numbers of similar cars = " + similarCars + "\n" +
                                            "Characteristics of the cars: " + cars[0].toString()
                            );
                            break;
                        default:
                            logger.info("Bye - bye");
                    ...
                    logger.error("You had entered illegal argument, please read the terms carefully.");
                }
            }
        }catch (InputMismatchException ex){
            logger.error("When you choose the action you should enter only numbers!");
        }
    }
}
